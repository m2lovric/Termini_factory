...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{display:flex;flex-direction:column;font-family:'Roboto', sans-serif}body #btn-container{width:60%;margin:0 auto}.term{display:flex;flex-flow:column wrap;align-items:center;justify-content:center;width:100%}.term__article{display:flex;flex-direction:column;align-items:center;width:60%;height:150px;border-radius:5px;margin-bottom:20px;background-color:#ededed}.term__article__header{align-self:flex-start;font-weight:500;margin-left:5%}.term__article__dropdowns{width:90%}.term__article__dropdowns select{margin-right:10px;height:36px;width:100px}\n", ""]);
// Exports
...
let src_text = document.createTextNode('Dodaj još jedan termin');
addBtn.setAttribute("id", "btn");
addBtn.appendChild(src_text);
